# Unity 2D Core Project Context

This document provides an overview of the Unity 2D Core project, based on the analysis of its configuration files.
...
- **Application Identifier (Standalone):** com.DefaultCompany.2D-URP
- **Template Used:** Universal 2D Template (com.unity.template.universal-2d@6.1.1)
